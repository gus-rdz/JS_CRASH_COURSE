...
// Sort a list of elements using Shell sort
// function shellSort(arr) {
//   var increment = arr.length / 2;
//   while (increment > 0) {
//       for (i = increment; i < arr.length; i++) {
...
// Function to truncate a string if it is longer than the specified number of characters
...
// Find an element in a given sorted array of elements using Interpolation Search
...
// Function to convert an object into a list of '[key, value]' pairs
// function key_value_pairs(obj)
//    {
//     var keys = _keys(obj);
//     var length = keys.length;
...
// Function Bit Manipulation Exercise
// const log_Two = (n) => {
//   if (typeof n!= "number") {
//       return 'It must be number!'
//       }
...
// Program to empty a singly linked list by pointing the head towards null
// class Node {
//   constructor(data) {
//       this.data = data
//       this.next = null
...
// first index of a given element in an array using the ternary search algorithm
// const ternary_Search = (arr, target, left, right) => {
// 	if (right >= left) {
// 		let mid1 = Math.floor(left + (right - left) /3);
// 		let mid2 = Math.floor(right - (right - left) /3);
...
// Sort a list of elements using Gnome sort
...
// Program to find next power of two of a given number
...
// Linked List Exercise (removes the tail element from a Singly Linked list)
// class Node {
//     constructor(data) {
//         this.data = data
//         this.next = null
...
// Recursion for Palindrome program
// const test = (text) => {
...
// JS Math - calculate the sum of all odd elements in a square matrix
// function test(nums) {
...
// JS Date for ISO-8601 numeric representation
